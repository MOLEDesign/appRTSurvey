function questionSubmit() {
    ...
    var url = "http://www.gwtrains.co.uk/rtsurvey/server/post.php"; // the script where you handle the form input.
...
function askSubmit() {
    ...
    var url = "http://www.gwtrains.co.uk/rtsurvey/server/post_ask.php"; // the script where you handle the form input.
